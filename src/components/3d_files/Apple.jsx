...
Command: npx gltfjsx@6.1.4 apple.gltf --transform
Author: Moshe Caine (https://sketchfab.com/mosheca)
License: CC-BY-4.0 (http://creativecommons.org/licenses/by/4.0/)
Source: https://sketchfab.com/3d-models/apple-da0cfd4c6a4e41c5aaf06797b463235b
Title: Apple
*/
...
export default function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <group position={[-354.11, 658.96, 591.69]} rotation={[1.26, -1.09, 1.53]}>
